...
ဒီနေရာမှာ Jenkins ကနေ လိုအပ်တဲ့ဟာမှန်သမျှကို အကုန် pull လုပ်ပြီးသွားဖို့ အချိန်နည်းနည်း စောင့်ရမှာ ဖြစ်ပါတယ်။ အဲ့တာပြီးသွားရင်် 03-jenkins-automation directory ထဲမှာ `jenkins_home` တက်လာမှာ ဖြစ်ပါတယ်။

### 3. Unlocking Jenkins

ဆက်လုပ်ရမှာ Jenkins Dashboard (http://localhost:8080) ကို ဝင်ပြီး admin password တွေအတွက် setup လုပ်စရာရှိတာ လုပ်ပေးသွားရမှာဖြစ်ပါတယ်။ Password ကို ယူဖို့အတွက် နည််းနှစ်မျိုးနဲ့ လုပ်လို့ရပါတယ်။
...
ရလာတဲ့ password ကိုသုံးပြီး `Unlock` လုပ်ပြီးရင် ကျန်တာက `Install suggested plugins` ကို ရွေးပြီး Git နဲ့ Pipeline အတွက် လိုအပ်တဲ့ plugins တွေကို ဆက်ထည့်သွားရုံပါပဲ။
