...
`Docker Compose` ဖိုင်ကတော့ `lab 3` ကလို တူတူထားသွားမှာ ဖြစ်ပါတယ်။
...
- **Automation Trigger:** `lab 3` မှာလို `Poll SCM` လိုဟာမျိုးကို အသုံးပြုပြီးတော့ `H/2 * * * *` နှစ်မိနစ်တစ်ခါ `GitHub` ဆီကို သွားပြီး code အသစ် push လုပ်ထားတာ ရှိမရှိ စစ်ဆေးခိုင်းထားလို့လည်း ရပါတယ်။
