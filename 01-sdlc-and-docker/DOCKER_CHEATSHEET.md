...
# ကိုယ့်ရဲ့ကွန်ပျူတာထဲကို ဒေါင်းလုပ်ဆွဲချချင်ရင်တော့ `pull` command ကို သုံးရပါတယ်။
...
```bash
# ပုံမှန်အားဖြင့်ဆိုရင် container တစ်ခု အလုပ်လုပ်နေတဲ့အချိန်မှာ
# ထွက်လာတဲ့ output logs တွေဆိုတာ ရှိပါတယ်။
